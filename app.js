...
function updateUser(id, name) {
  if (
    ...
    if (utils.checkUser(clients, name) || name == "Console" || name == "System")
      motive = "taken";
...
//       var string =
//         "Console gave " + line.substring(6) + " administrator permissions";
